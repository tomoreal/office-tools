...
Dim currentYear, currentType, prevItem
...
MsgBox "処理が完了しました（スマートソート適用済）。" & vbCrLf & "出力ファイル: " & newFilePath, vbInformation, "完了"
"""

vbs_path = "/home/tomo/work_office/財務データ横展開_CSV対応版.txt"
